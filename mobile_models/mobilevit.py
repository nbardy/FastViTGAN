# I need to add to add conditioning capabilities to this model
# Not sure if I need this one anymore
#
import torch
...
# Using the same attention to fuse the modalities
# We take the attention of each item and then concat and
# apply a linear layer to get project back to the input space
